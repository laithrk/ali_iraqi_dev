...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "💢نورت/ي يا🍷🌝 "..nama.."\n💢اهلا وسهلا في كروب 🔚 '"..string.gsub(msg.to.print_name, "_", " ").."'\n💢نورت/ي الكروووب 🤗💋️\n"
      local text = sambutan.."💢لرؤية القوانين #ro"
      local text = text.."                   💢رؤيه اوامر البوت help"
      local text = text.."                  💢خروج من المجموعة #kkme"
      local text = text.."                  💢دعم البوت @DEVBOT_A"
      local text = text.."\n"
      local text = text.."♣️Dev Bot 🤖 : @ali_iraqi"
      local receiver = get_receiver(msg)
...
local function run(msg, matches)
   ...
   elseif matches[1] == "chat_del_user" then
       ...
       return 'شكرا لك|ي لقد امضيناا وقتاً جميلاً وداعاًاا 🙂👋🏿👋🏿'..bye_name
   end
end
